from src.add_keys import add_dcirs_keys, add_dcir_keys, add_beneficiary_central_table_DCIR_keys, \
    add_beneficiary_central_table_DCIRS_keys, add_DCIR_beneficiary_link, add_DCIRS_beneficiary_link, \
    add_DA_PRA_R_keys, add_cartographie_pathologies_foreign_keys
